...
const SECTIONS = [
  {
    title: 'رؤيتنــــا',
    content: 'أن نكون المرجع الإقليمي في صناعة الثقافة الملهمة، الممتدة في عمق التاريخ، والمؤثرة في حاضر الأجيال ومستقبلها',
    bg: 'bg-[#783424]'
  },
  {
    title: 'رسالتنـــا',
    content: 'نوثق الهوية المشتركة للأفراد والمجتمعات بما يعكس القيم والفكر والفن لنحفظها كما تستحق، ونخلدها كما ينبغي، بهدف تشكيل روح مستدامة تلهم الأجيال عبر التاريخ',
    bg: 'bg-[#78441c]'
  },
  {
    title: 'قيمنـــا',
